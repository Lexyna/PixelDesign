...
public class MainController implements Initializable {
    ...
    private void addCanvasListener(Canvas fx_canvas){
        fx_canvas.setOnMouseMoved((evt)->{
            ...
            if(ParticleSystemManager.getInstance().getActiveSystem().getPixelMap().getMouseCoord() == null  ||
                    !cord.equals(ParticleSystemManager.getInstance().getActiveSystem().getPixelMap().getMouseCoord())){
